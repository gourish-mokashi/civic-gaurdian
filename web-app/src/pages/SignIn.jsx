    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-50 items-center justify-center border-r border-gray-200">
        <h1 className="text-4xl font-bold text-gray-900 max-w-sm leading-tight">
          Civic-Guardian <span className="text-emerald-600">Admin Portal</span>
        </h1>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-6 bg-white">
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-emerald-600 px-4 py-2 text-white font-medium shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
              Sign In
            </button>
          </form>
